    ...
    <div className="min-h-screen bg-white text-[#0b2b5c]">
      <main className="mx-auto max-w-5xl px-6 py-24 sm:py-32">
        <section className="flex flex-col items-center text-center gap-6">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight">
            Welcome to <span className="underline decoration-[#d4af37] underline-offset-8">Forum-ENSA</span>
          </h1>
          <p className="text-lg sm:text-xl text-[#143d7a]/90 max-w-2xl">
            Hello and welcome to the official website of Forum-ENSA Tétouan.
            Stay tuned for updates, events, and community news.
          </p>
      ...
      <footer className="border-t border-[#0b2b5c]/10">
        <div className="mx-auto max-w-5xl px-6 py-8 text-sm text-[#143d7a]/80 flex items-center justify-between">
          ...
          <span className="text-[#d4af37] font-semibold">Official Website</span>
        </div>
      </footer>
    </div>
  );
